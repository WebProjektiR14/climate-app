...
export default class DataV1AnnualChart extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:8080/datav1na')
            ...
            axios.get('http://localhost:8080/datav1sa')
            .then(res => {
                this.setState({chart3Data: res.data});
            })
            axios.get('http://localhost:8080/datav2')
            .then(res => {
    ...
    render() {
        ...
        return (
            <div style={{ width: "90%", align:"" }}>
                <h1>Global historical surface temperature anomalies from January 1850 onwards (Annual data)</h1>
